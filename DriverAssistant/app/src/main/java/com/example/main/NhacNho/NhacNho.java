...
public class NhacNho extends Activity {
    TextView txtDate,txtTime;
    EditText editCv,editNd;
    Button btnDate,btnTime,btnAdd;
    //Khai báo Datasource lưu trữ danh sách công việc
    ArrayList<com.example.main.NhacNho.CongViec>arrJob=new ArrayList<com.example.main.NhacNho.CongViec>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter<com.example.main.NhacNho.CongViec>adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<com.example.main.NhacNho.CongViec>
                (this,
    ...
    public void processAddJob()
    {
        ...
        com.example.main.NhacNho.CongViec job=new com.example.main.NhacNho.CongViec(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
